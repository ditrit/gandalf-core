...
func GetRouter(databaseConnection *database.DatabaseConnection, shoset *net.Shoset) *mux.Router {
	...
	//PIVOT
	subt.HandleFunc(urls.PIVOT_TYPE_PATH_LIST, controllers.PivotController.List).Methods("GET")
	...
	//CONNECTOR PRODUCT
	subt.HandleFunc(urls.PRODUCT_CONNECTOR_PATH_LIST, controllers.ProductConnectorController.List).Methods("GET")
	subt.HandleFunc(urls.PRODUCT_CONNECTOR_PATH_READ, controllers.ProductConnectorController.Read).Methods("GET")
	subt.HandleFunc(urls.PRODUCT_CONNECTOR_PATH_READ_BY_NAME, controllers.ProductConnectorController.ReadByName).Methods("GET")
